#ifndef __SHELL_ML_H__
#define __SHELL_ML_H__
...
#if !defined(PART_OF_SHELL) && \
    !defined(STATIC_LINK_SHELL) && \
    !defined(DYNAMIC_LINK_SHELL)
#define PART_OF_SHELL
#endif

#if defined(PART_OF_SHELL)
#define MLLIB_PRIVATE(x) PRIVATE x
#define MLLIB_PUBLIC(x) PUBLIC x
#elif defined(STATIC_LINK_SHELL)
#define MLLIB_PRIVATE(x)
#define MLLIB_PUBLIC(x) PUBLIC x
#elif defined(DYNAMIC_LINK_SHELL)
#define MLLIB_PRIVATE(x)
#define MLLIB_PUBLIC(x) EXTERNAL x
#else
#error Must specify linkage for shell
#define MLLIB_PRIVATE(x)
...
MLLIB_PUBLIC(void printFromMLton ();)
